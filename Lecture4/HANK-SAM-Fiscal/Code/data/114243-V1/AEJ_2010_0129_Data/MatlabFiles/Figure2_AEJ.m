...
comp1=1;                            % set to one to plot impulse responses to MP shocks from VAR and R&R
comp2=0;                            % set to one to plot impulse responses to MP shocks using R&R univariate approach on VAR shocks.
fitindex=0;                         % set to one to plot predicted paths due to MP shocks from VAR and R&R
