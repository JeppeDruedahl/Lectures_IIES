...
% estimated Taylor rule with TVP 
clear all
warning('off')
...
MPshockdataCG;                        % loads data with MP shocks from TVP.
uRR2=uRR;

% note: uRR1 is originial R&R shocks, uRR2 is shocks from TVP
...
t=1970:1/12:1996+11/12;
    ...
    legend('Original R&R shocks','R&R TVC shocks')
