...
function [p1, P]=AICsimGENb(Y,X,N,lagAIC,ARlags,levelindex,periods,jmin,jmax,kmin,kmax,minindex,incr);
...
% incr is increments for lag iterations: i.e. 3 means 3-month increments
