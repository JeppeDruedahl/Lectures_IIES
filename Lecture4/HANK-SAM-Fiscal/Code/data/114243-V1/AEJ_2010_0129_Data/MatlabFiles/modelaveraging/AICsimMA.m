...
function [p1]=AICsimMA(Y,X,N,lagAIC,ARlags,levelindex,periods,ARvec,MAvec,minindex);
...
mpshocksDAT=[ X(1:length(X)-1,1+ARlags+1); 0];         % original shocks (makes use of fact that only lagged shocks are used in regression
